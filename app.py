...
分析は中長期（3〜10年）目線で行い、最新の成長テーマ（AI、量子コンピュータ、半導体、DX、ESG等）を積極的に考慮してください。また、中長期投資としてのおすすめ度をA〜E段階で評価してください。"""
...
出力は「決算の総合評価・良い点・懸念点・中長期投資家としての判断材料・今後の注意点」の見出し＋箇条書き形式で整理してください。また、中長期投資としてのおすすめ度をA〜E段階で評価してください。"""
